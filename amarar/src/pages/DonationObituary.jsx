    ...
    return (
        <div>
            ...
            <div className='container'>
                <h2>If you need to add a donation <a href='/donations' style={ { fontStyle: 'italic', fontSize: '32px', fontWeight: 'bold', color: '#326346', fontFamily: 'Manuale', textDecoration: 'none' } }>Click Here</a></h2>
