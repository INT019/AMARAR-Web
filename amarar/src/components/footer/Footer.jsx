            ...
            <div className='footer-links'>
                <nav className='footer-link-nav'>
                    <ul className='footer-link-ul'>
                        ...
                        <li className='footer-link-li'><a className='footer-link-a' href='/adminlogin'>Admin</a></li>
                        <li className='footer-link-li'><a className='footer-link-a' href='/Login'>Login</a></li>
                    </ul>
                </nav>
